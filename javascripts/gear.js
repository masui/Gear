...
var AnimationTime, ExpandTime, HideAnimationTime, HideTime, StepTime, autoexpand, browserHeight, calc, dispLine, display, dontShowSingleNode, downfunc, expand, expandTimeout, fire, gearname, hashIndex, hideLines, hideTimeout, initData, intValue, json, keydownfunc, linda, mousewheelevent, move, movefunc, nasty, nextNode, nodeList, node_app, oldNodeList, oldSpans, pauseAtLevelChange, prevNode, refresh, repeatedfunc, resizefunc, root, say, sayCGI, setup_paddle, showContents, singleWindow, spans, ts, typeCount, typeCountTimeout, upfunc, useAnimation, useAudio, use_linda,
...
mousewheelevent = indexOf.call(document, 'onwheel') >= 0 ? 'wheel' : indexOf.call(document, 'onmousewheel') >= 0 ? 'mousewheel' : 'DOMMouseScroll';
