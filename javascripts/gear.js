...
$(function() {
  ...
  return exports.ltsv(gyazz, gearname, function(data) {
...
mousewheelevent = __indexOf.call(document, 'onwheel') >= 0 ? 'wheel' : __indexOf.call(document, 'onmousewheel') >= 0 ? 'mousewheel' : 'DOMMouseScroll';
