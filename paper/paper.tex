...
\caption{Asking people to use Strotor at an exhibition. The subject is using PowerMate for browsing photos.}
\label{powermate}
\end{figure}
...
We have developed a new very simple interaction method for exploring
large hierarchical data structure.
Using only one rotating device,
