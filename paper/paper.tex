...
\tsf{Fresh grocery} category is selected (Figure \ref{fig6}), and
...
the shops under \tsf{Fresh grocery} disappears (Figure \ref{fig6}).
...
\tsf{Clothing} is selected, and the display changes to Figure \ref{fig8}.
